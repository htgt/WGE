use utf8;
package WGE::Model::Schema::Result::CrisprPairsGrch38;
## no critic(RequireUseStrict,RequireUseWarnings)
{
    $WGE::Model::Schema::Result::CrisprPairsGrch38::VERSION = '0.097';
}
## use critic
...
=head1 TABLE: C<crispr_pairs_grch38>

=cut

__PACKAGE__->table("crispr_pairs_grch38");
...
__PACKAGE__->add_unique_constraint("unique_grch38_pair_id", ["id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IwG97fRVyzOenjqd7f+1mg
