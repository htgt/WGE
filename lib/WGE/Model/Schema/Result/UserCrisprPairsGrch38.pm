use utf8;
package WGE::Model::Schema::Result::UserCrisprPairsGrch38;
## no critic(RequireUseStrict,RequireUseWarnings)
{
    $WGE::Model::Schema::Result::UserCrisprPairsGrch38::VERSION = '0.078';
}
## use critic
...
=head1 TABLE: C<user_crispr_pairs_grch38>

=cut

__PACKAGE__->table("user_crispr_pairs_grch38");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:u6JLC7LQh8ujtawHBR2VAQ
