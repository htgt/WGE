use utf8;
package WGE::Model::Schema::Result::UserCrisprPairsHuman;
## no critic(RequireUseStrict,RequireUseWarnings)
{
    $WGE::Model::Schema::Result::UserCrisprPairsHuman::VERSION = '0.032';
}
## use critic
...
=head1 TABLE: C<user_crispr_pairs_human>

=cut

__PACKAGE__->table("user_crispr_pairs_human");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bnRgYwqysiQf9n6WgASaRg
